...
namespace Ui {
    ...
    public:
        ...
        explicit user_info(QString _name = "Новый пользователь",
                           QString _uuid = bWebSocket::nilUuid(),
...
public:
    explicit UserDialog(QWidget *parent, Ui::user_info * usr_info);
    ~UserDialog();

private slots:
    void on_btnSelectUserInfoBase_clicked();

    void on_btnEditPwd_toggled(bool checked);

    void on_UserDialog_accepted();
