...
public:
    ...
    void
    send(const std::string &message, bool is_cmd = true, const std::string& sub_user_uuid = "", const std::string& uuid_form = "", const std::string& command = "message");
    ...
    void
    on_read(const std::string& message);
...
//    std::string _uuid_form;
    ...
    void concole_log(const std::string logText){
