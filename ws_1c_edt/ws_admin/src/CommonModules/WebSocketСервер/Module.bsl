...
Процедура ЗаписатьВЖурнал(Описание, УровеньОшибка = Ложь) Экспорт
	Если НЕ УровеньОшибка Тогда
...
Функция ПолучитьПользователяПоКодуНаСервере(ИмяПользователя) Экспорт
	Возврат Справочники.Пользователи.НайтиПоКоду(ИмяПользователя);
КонецФункции
...
Функция ТекущийПользователь() Экспорт
	...
	Если ТипЗнч(ТекПользователь) = Тип("СправочникСсылка.Пользователи") Тогда
		Возврат Новый Структура("Ссылка,Наименование,Код",  ТекПользователь, ТекПользователь.Наименование, ТекПользователь.Код); 
	Иначе
