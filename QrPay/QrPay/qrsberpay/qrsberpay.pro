...
OTHER_FILES += android/src/ru/arcirk/utils/QShareUtils.java \
    android/src/ru/arcirk/java/sharex/QShareActivity.java \
    android/src/ru/arcirk/utils/QSharePathResolver.java
...
ios {
    ...
    MY_BUNDLE_ID.value = ru.arcirk.qrsberpay
