    ...
    public static String getRealPathFromURI(final Context context, final Uri uri) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isExternalStorageDocument(uri)) {
                Log.d("arcirk"," isExternalStorageDocument");
            ...
            // DownloadsProvider
                ...
                Log.d("arcirk"," isDownloadsDocument");
                final String id = DocumentsContract.getDocumentId(uri);
                Log.d("arcirk"," getDocumentId "+id);
                long longId = 0;
                try
                  {
            ...
            // Other Providers
                ...
                Log.d("arcirk ","is Other Provider");
                try {
        ...
        // MediaStore (and general)
            ...
            Log.d("arcirk ","NOT DocumentsContract.isDocumentUri");
            Log.d("arcirk"," is uri.getScheme()");
            // Return the remote address
            if (isGooglePhotosUri(uri))
                return uri.getLastPathSegment();
            Log.d("arcirk"," return: getDataColumn ");
            return getDataColumn(context, uri, null, null);
        }
        // File
        else if ("file".equalsIgnoreCase(uri.getScheme())) {
            Log.d("arcirk ","NOT DocumentsContract.isDocumentUri");
            Log.d("arcirk"," is file scheme");
            return uri.getPath();
        }
