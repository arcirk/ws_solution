...
bool AndroidShareUtils::checkMimeTypeView(const QString &mimeType)
{
    ...
    jboolean verified = QAndroidJniObject::callStaticMethod<jboolean>("ru/arcirk/utils/QShareUtils",
                                              "checkMimeTypeView",
                                              "(Ljava/lang/String;)Z",
...
void AndroidShareUtils::share(const QString &text, const QUrl &url)
{
    ...
    jboolean ok = QAndroidJniObject::callStaticMethod<jboolean>("ru/arcirk/utils/QShareUtils",
                                              "share",
...
JNIEXPORT void JNICALL
  Java_ru_arcirk_java_sharex_QShareActivity_setFileUrlReceived(JNIEnv *env,
                                        jobject obj,
                                        jstring url)
{
...
JNIEXPORT void JNICALL
  Java_ru_arcirk_java_sharex_QShareActivity_setFileReceivedAndSaved(JNIEnv *env,
                                        jobject obj,
                                        jstring url)
{
    const char *urlStr = env->GetStringUTFChars(url, NULL);
...
JNIEXPORT bool JNICALL
  Java_ru_arcirk_java_sharex_QShareActivity_checkFileExits(JNIEnv *env,
                                        jobject obj,
                                        jstring url)
{
    const char *urlStr = env->GetStringUTFChars(url, NULL);
...
JNIEXPORT void JNICALL
  Java_ru_arcirk_java_sharex_QShareActivity_fireActivityResult(JNIEnv *env,
                                        jobject obj,
                                        jint requestCode,
                                        jint resultCode)
{
